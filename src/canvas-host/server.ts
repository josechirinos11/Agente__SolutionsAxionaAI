...
<title>SolutionsAxionaAI Canvas</title>
<style>
...
<div class="wrap">
  <div class="card">
    <div class="title">
      <h1>SolutionsAxionaAI Canvas</h1>
    ...
    try {
      ...
      if (!opened) {
        if (urlPath === "/" || urlPath.endsWith("/")) {
          ...
          res.end(
            `<!doctype html><meta charset="utf-8" /><title>SolutionsAxionaAI Canvas</title><pre>Missing file.\nCreate ${rootDir}/index.html</pre>`,
          );
          return true;
        }
        res.statusCode = 404;
